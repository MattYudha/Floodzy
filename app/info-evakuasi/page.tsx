...
export default function InfoEvakuasiPage() {
  ...
  const StatusLegend = () => (
    <div className="bg-slate-700/30 border border-slate-600/30 rounded-lg p-3 mb-4 text-xs">
      <h5 className="font-semibold text-white mb-2">Keterangan Status Kapasitas:</h5>
      <div className="flex flex-col space-y-1.5">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-green-500 flex-shrink-0 border border-slate-400/50" />
          <span className="text-slate-300">Tersedia (di bawah 70%)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-orange-400 flex-shrink-0 border border-slate-400/50" />
          <span className="text-slate-300">Hampir Penuh (70% - 99%)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-red-500 flex-shrink-0 border border-slate-400/50" />
          <span className="text-slate-300">Penuh (100%)</span>
        </div>
      </div>
    </div>
  );
  ...
  if (loading) {
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-4">
        <div className="flex justify-center items-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-xl font-medium text-white">Memuat lokasi evakuasi...</p>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-4">
        <div className="flex flex-col justify-center items-center min-h-[60vh]">
          <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-8 text-center">
            ...
            <p className="text-xl font-medium text-white mb-2">Gagal Memuat Data</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-4">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center"><Home className="w-5 h-5 text-blue-400" /></div>
              <div>
                <p className="text-2xl font-bold text-white">{evacuationLocations.length}</p>
                <p className="text-slate-400 text-sm">Total Lokasi</p>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-green-500/20 rounded-lg flex items-center justify-center"><Users className="w-5 h-5 text-green-400" /></div>
              <div>
                <p className="text-2xl font-bold text-white">{evacuationLocations.reduce((acc, loc) => acc + (loc.capacity_total - loc.capacity_current), 0)}</p>
                <p className="text-slate-400 text-sm">Kapasitas Tersisa</p>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }} className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-500/20 rounded-lg flex items-center justify-center"><AlertTriangle className="w-5 h-5 text-orange-400" /></div>
              <div>
                <p className="text-2xl font-bold text-white">{evacuationLocations.filter((loc) => (loc.capacity_current / loc.capacity_total) >= 0.7).length}</p>
                <p className="text-slate-400 text-sm">Hampir Penuh</p>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-cyan-500/20 rounded-lg flex items-center justify-center"><Clock className="w-5 h-5 text-cyan-400" /></div>
              <div>
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.7 }} className="lg:col-span-2">
          <div className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Peta Lokasi Evakuasi</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.8 }} className="lg:col-span-1">
          <div className="bg-slate-800/80 backdrop-blur-sm border border-slate-600/50 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Daftar Lokasi</h3>
            </div>
                ...
                {evacuationLocations.map((loc, index) => {
                  ...
                  return (
                    <motion.div key={loc.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 + index * 0.05 }}>
                      <div className="bg-slate-700/50 border border-slate-600/30 rounded-lg p-4 cursor-pointer hover:bg-slate-700/70 transition-all group" onClick={() => handleLocationClick(loc)}>
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="font-medium text-white text-sm group-hover:text-cyan-400 transition-colors">{loc.name}</h4>
                          <span className={`px-2 py-1 rounded-full text-xs border ${statusBadge.color}`}>{statusBadge.text}</span>
                        </div>
                        <div className="flex items-center gap-1 mb-2">
                          <MapPin className="w-3 h-3 text-slate-500 flex-shrink-0" />
                          <p className="text-xs text-slate-400 line-clamp-1">{loc.address}</p>
                        </div>
            ...
            <div className="bg-slate-800 border border-slate-600/50 rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button onClick={() => setIsDialogOpen(false)} className="text-slate-400 hover:text-white transition-colors">
                  ...
                  <div className="bg-slate-700/50 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white font-medium">Status Operasional</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between mt-4 mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white font-medium">Kapasitas</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-white font-medium">{selectedLocation.capacity_current} / {selectedLocation.capacity_total} orang</span>
                    </div>
                    ...
                    <div className="bg-slate-700/50 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        {Object.entries(selectedLocation.essential_services).map(([key, value]) => (
                            <div key={key} className="bg-slate-600/50 rounded-lg px-3 py-2 flex items-center gap-2">
                    ...
                    <div className="bg-slate-700/50 rounded-lg p-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedLocation.facilities.map((facility, idx) => (
                          <div key={idx} className="bg-slate-600/50 rounded-full px-3 py-1">
                  ...
                  <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                    ...
                    {selectedLocation.contact_person && (
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-white">{selectedLocation.contact_person}</span>
                      </div>
                    )}
                    ...
                    <div className="pt-2 border-t border-slate-700/50 space-y-2">
                        {selectedLocation.last_updated && (
                          <div className="flex items-center justify-between text-xs">
                            ...
                            <span className="text-slate-400">{new Date(selectedLocation.last_updated).toLocaleString('id-ID', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</span>
                          </div>
                        )}
                        {selectedLocation.verified_by && (
                          <div className="flex items-center justify-between text-xs">
                            <span className="text-slate-500">Terverifikasi oleh:</span>
                            <span className="text-white font-medium">{selectedLocation.verified_by}</span>
                          </div>
                        )}
                    </div>
                  </div>
